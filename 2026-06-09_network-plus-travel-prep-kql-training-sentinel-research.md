...
Continued active Network+ N10-009 exam prep throughout the week. Primary methods: Professor Messer video review, Anki flashcard drilling, and Jason Dion practice questions.
...
Practice exam scores in progress. Target: 75%+ before sitting the exam.
...
## Microsoft Sentinel & Defender XDR Research

Conducted focused research on Microsoft's cloud security stack ahead of an industry networking call.

**Microsoft Sentinel**
- Cloud-native SIEM/SOAR built on Azure Log Analytics
- Query language: KQL
- Ingests logs from endpoints, identity, email, cloud, and network sources
- Detection rules, analytics, and automated playbooks all on the same platform
- Used heavily in MSSP environments for multi-tenant monitoring

**Microsoft Defender XDR**
- Extended Detection and Response correlating signals across:
  - Defender for Endpoint (EDR)
  - Defender for Identity (AD/LDAP monitoring)
...
**Takeaway:** SOC and DFIR work overlap significantly at Tier 2 in MSSP environments. Direct conversations with active SOC managers provide signal that no study plan replicates.

---

## TryHackMe

Continued progress on the **Cyber Security 101** and **SOC Level 1** pathways.

Profile: [JacobVranyesFast](https://tryhackme.com/p/JacobVranyesFast)
